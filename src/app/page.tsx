      ...
      <div className="max-w-3xl w-full">
        ...
        <div className="mt-10 border border-zinc-800 bg-zinc-900/20 p-4">
          ...
          <ol className="text-xs text-zinc-400 space-y-1.5 font-jb">
            <li>
              <span className="text-emerald-400">1.</span> {t.home.step1}
            </li>
            <li>
              <span className="text-emerald-400">2.</span> {t.home.step2}
            </li>
            <li>
              <span className="text-emerald-400">3.</span> {t.home.step3}
            </li>
            <li>
            ...
            <li>
              <span className="text-emerald-400">5.</span> {t.home.step5}
            </li>
          </ol>
        </div>
      </div>
